...
*   [args/kwargs](/rltoken/LroIjBBI5Gqq3ciR-OHmxg "args/kwargs")
*   [JSON encoder and decoder](/rltoken/TY4rfu2AZtXlRmPVNZm1Lw "JSON encoder and decoder")
*   [unittest module](/rltoken/T7uxwxtGdbRRW9pkD4eO0g "unittest module")
*   [Python test cheatsheet](/rltoken/SfEo3RQeAXXYI9yabFRw3g "Python test cheatsheet")

Learning Objectives
-------------------

At the end of this project, you are expected to be able to [explain to anyone](/rltoken/iFzb6_jETQypQs_pZHmUOQ "explain to anyone"), **without the help of Google**:
...
*   You have to use the [unittest module](/rltoken/T7uxwxtGdbRRW9pkD4eO0g "unittest module")
